...
export function DashboardDetailPanel({ detail, onClose }: DashboardDetailPanelProps) {
  ...
  return (
    <div className="animate-panel-slide-up absolute top-[16px] bottom-[16px] left-[16px] z-40 flex w-[400px] flex-col overflow-hidden rounded-lg bg-bg-default shadow-[0_0_4px_var(--color-alpha-black-5)]">
      <div
